                        ...
                        <div class="col-10">
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <td>
                                        <button type="submit" class="btn btn-danger" > <a href="?act=deletedm&id=<?= $dm['0']?>">Xóa</a></button>
                                        <button type="submit" class="btn btn-warning"><a href="?act=editdm&id=<?= $dm['0']?>">Sửa</a></button>
                                    </td>
